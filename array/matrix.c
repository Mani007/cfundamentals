int main(int argc, char const *argv[])
{
    ...
    int *p;
    p= a;
    printf("Address of pointer p to array a[1][0] is %d\n",p+3); // address of initial value of array pointer
    printf(" value of pointer *p to array a[1][0] is %d\n",*(p+3)); // 0
    printf(" value of array a[1][0] is %d\n",a[1][0]);  // 0
