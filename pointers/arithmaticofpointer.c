...
int main() {
    ...
    printf("Value of pointer ptr in hex is %p\n", ptr);
    printf("Value of pointer ptr in hex after adding +1 is %p\n", ptr+1);
    printf("Value STORED in pointer ptr in decimal is %d\n", *ptr);
    printf("Value STORED in pointer ptr in decimal after adding +1 is %d\n", *ptr+ 1); // This is adding value to pointer reference variable hence normal arithmetic    
